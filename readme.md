...
[Docker Image Size]: https://ghcr-badge.deta.dev/qemu-tools/qemu-docker/size?color=SteelBlue
[gh_last_release_svg]: https://ghcr-badge.deta.dev/qemu-tools/qemu-docker/tags?n=1&label=version&color=SteelBlue
